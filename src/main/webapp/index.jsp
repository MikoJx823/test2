	      	...
	      	<div class="container">
	        	<div class="navbar-header">
			        ...
			        <a class="navbar-brand" href="index.html">
			          	<img src="build/img/logo.svg" alt="Sham Theme">
			        </a>
	        	</div>
	...
	<div class="swiper-slider">
		...
		<div class="swiper-container fullscreen">
		    ...
		    <div class="swiper-wrapper text-center">
		        <!-- Slides -->
		        <div class="swiper-slide" style="background-image: url(build/img/slides/01.jpg);">
		        	<div class="valign-wrapper fullscreen">
		        		<div class="valign col-xs-offset-3" data-swiper-parallax="-100">
		        		</div>
		        	</div>
		        </div>
		        <div class="swiper-slide" style="background-image: url(build/img/slides/02.jpg);">
		        	<div class="valign-wrapper fullscreen">
		        		<div class="valign col-xs-offset-8" data-swiper-parallax="-100">
		        		</div>
		        	</div>
		        </div>
		        <div class="swiper-slide" style="background-image: url(build/img/slides/03.jpg);">
		        	<div class="valign-wrapper fullscreen">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 collection"> 
					...
					<div id="jssor_1" style="position:relative;margin: 0 auto;top:0px;left:0px;width:750px;height:500px;overflow:hidden;visibility:hidden;">
				        ...
				        <div data-u="slides" style="cursor:default;padding:10px;top:0px;left:0px;width:730px;height:500px;overflow:hidden;">
				            <div>
				                <img data-u="image" src="images/Dry-winter-snow-natural-hd-wallpaper.jpg" />
				            </div>
				            <div data-p="170.00"><a href="#">
				                <img data-u="image" src="images/IMG_2470.JPG" />
				            	</a>
				            </div>
				            <div data-b="0"> 
				...
				<div class="col-sm-6">
					<div class="row">
						<div class="col-sm-6 collection">
							<div id="jssor_2" style="position:relative;margin:0 auto;top:0px;left:0px;width:700px;height:450px;overflow:hidden;visibility:hidden;">
					        <!-- Loading Screen -->
					        <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
					            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="../svg/loading/static-svg/spin.svg" />
					        </div>
					        <div data-u="slides" style="cursor:default;padding:10px;top:0px;left:0px;width:680px;height:450px;overflow:hidden;">
					            <div>
					                <img data-u="image" class="img-responsive" src="../images/Dry-winter-snow-natural-hd-wallpaper.jpg" />
					            </div>
					            <div data-p="170.00"><a href="#">
					                <img data-u="image" class="img-responsive" src="../images/IMG_2470.JPG" />
					            	</a>
						...
						<div class="col-sm-12 collection">
							...
							<div id="jssor_4" style="position:relative;margin:0 auto;top:0px;left:0px;width:750px;height:250px;overflow:hidden;visibility:hidden;">
					        <!-- Loading Screen -->
					        <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
					            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="../svg/loading/static-svg/spin.svg" />
					        </div>
			...
			<div class="row">
				...
				<div class="pos-r clearfix">
					<ul style="text-align:center;">
    					...
    					<!--   style="float:left;width:20%;padding:30px" -->
					    <a href="https://www.instagram.com/p/BDX1oYbxJCK" target="_blank">
						    <img data-u="image" src="../images/Dry-winter-snow-natural-hd-wallpaper.jpg" height="120px"/>
					    </a>
					    </li>
					    <li style="display:inline-block;*display:inline;padding:5px">
					    <a href="https://www.instagram.com/p/BDX1oYbxJCK" target="_blank">
			...
			<div class="widgets">
				<div class="row">
					<div class="col-sm-6 widget widget-about">
						<h3 class="widget-title" style="color:white">Sham</h3>
